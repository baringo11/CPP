...
/*   Updated: 2021/10/15 22:06:28 by jbaringo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << this->name << " received " << amount << " points of damage :(";
...
{
	this->hitpoints += amount;
	std::cout << this->name << " repaired " << amount << " hitpoints, now it has " << this->hitpoints << "! :)" << std::endl;
}
